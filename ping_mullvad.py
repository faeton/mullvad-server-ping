...
if __name__ == "__main__":
    ...
    parser.add_argument('--active', '-a', dest='active', type=bool, help="Filter by active status (True/False)")
    parser.add_argument('--owned', '-o', dest='owned', type=bool, help="Filter by owned status (True/False)")
